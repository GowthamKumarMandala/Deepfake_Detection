...
def predict_img():
    if request.method == "POST":
        if 'file' in request.files:
            ...
            return render_template('display_image.html', result=ans,imagepath=img_path)
    ...
    if request.method == "POST":
        if 'file' in request.files:
            ...
            if filename.lower().endswith(('.mp4', '.avi', '.mkv')):
                ...
                print("Count real:",count_real)
                print("Count fake:",count_fake)
                if count_fake > count_real and count_real<65:
                    ans = 'Fake'
                else:
                    ans = 'Real'
            ...
            return render_template('display_image.html', result=ans,videopath=file_pth)
